...
import image from '../images/144983-camera-vector-camcorder-film-png-download-free.png'
...
const Header = ({onSwitch}) => {
    return ( <>
     <header className="flex justify-between items-center px-4 md:px-20 py-8 bg-whiteLMDM shadow-lg dark:bg-darkBlue">
        <img alt='' className="font-bold text-veryDarkBlueLM dark:text-whiteLMDM w-[90px] h-[50px] " src={image}/>
